...
![The effect of sunlight has obscured the effect of soil type](confounds1.png)
...
![The effect of sunlight has created an "artificial" effect of soil type](confounds2.png)
...
![Matched pairs design](matched-pairs.png)
...
![Blocked randomisation to conditions](block-random.png)
...
![Counterbalancing a sample across two tasks](counterbalancing.png)
...
![Sunlight cannot be treated as a covariate of no interest](confounds3.png)
